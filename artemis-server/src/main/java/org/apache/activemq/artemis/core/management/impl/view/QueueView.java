...
public class QueueView extends ActiveMQAbstractView<QueueControl, QueuePredicateFilterPart> {
   ...
   public JsonObjectBuilder toJson(QueueControl queue) {
      ...
      JsonObjectBuilder obj = JsonLoader.createObjectBuilder()
         ...
         .add(QueueField.NAME.getName(), queue.getName())
         .add(QueueField.ADDRESS.getName(), queue.getAddress())
         .add(QueueField.FILTER.getName(), queue.getFilter())
         ...
         .add(QueueField.ROUTING_TYPE.getName(), queue.getRoutingType())
         ...
         .add(QueueField.LAST_VALUE_KEY.getName(), queue.getLastValueKey())
         ...
         .add(QueueField.GROUP_FIRST_KEY.getName(), queue.getGroupFirstKey())
