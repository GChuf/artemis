...
public class QueueView extends ActiveMQAbstractView<QueueControl, QueuePredicateFilterPart> {
   ...
   public JsonObjectBuilder toJson(QueueControl queue) {
      ...
      JsonObjectBuilder obj = JsonLoader.createObjectBuilder()
         ...
         .add(QueueField.CONSUMER_COUNT.getName(), queue.getConsumerCount())
         .add(QueueField.MAX_CONSUMERS.getName(), queue.getMaxConsumers())
         ...
         .add(QueueField.MESSAGES_ADDED.getName(), queue.getMessagesAdded())
         .add(QueueField.MESSAGE_COUNT.getName(), queue.getMessageCount())
         .add(QueueField.MESSAGES_ACKED.getName(), queue.getMessagesAcknowledged())
         .add(QueueField.MESSAGES_EXPIRED.getName(), queue.getMessagesExpired())
         .add(QueueField.DELIVERING_COUNT.getName(), queue.getDeliveringCount())
         .add(QueueField.MESSAGES_KILLED.getName(), queue.getMessagesKilled())
         ...
         .add(QueueField.SCHEDULED_COUNT.getName(), queue.getScheduledCount())
         ...
         .add(QueueField.GROUP_BUCKETS.getName(), queue.getGroupBuckets())
         ...
         .add(QueueField.RING_SIZE.getName(), queue.getRingSize())
         .add(QueueField.CONSUMERS_BEFORE_DISPATCH.getName(), queue.getConsumersBeforeDispatch())
         .add(QueueField.DELAY_BEFORE_DISPATCH.getName(), queue.getDelayBeforeDispatch())
