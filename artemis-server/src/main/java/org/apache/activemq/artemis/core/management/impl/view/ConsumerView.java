...
public class ConsumerView extends ActiveMQAbstractView<ServerConsumer, ConsumerPredicateFilterPart> {
   ...
   public JsonObjectBuilder toJson(ServerConsumer consumer) {
      ...
      JsonObjectBuilder obj = JsonLoader.createObjectBuilder()
         ...
         .add(ConsumerField.SESSION.getName(), consumer.getSessionName())
         .add(ConsumerField.CLIENT_ID.getName(), consumer.getConnectionClientID())
         .add(ConsumerField.USER.getName(), session.getUsername())
         .add(ConsumerField.VALIDATED_USER.getName(), session.getValidatedUser())
         .add(ConsumerField.PROTOCOL.getName(), consumer.getConnectionProtocolName())
         ...
         .add(ConsumerField.LOCAL_ADDRESS.getName(), consumer.getConnectionLocalAddress())
         .add(ConsumerField.REMOTE_ADDRESS.getName(), consumer.getConnectionRemoteAddress())
